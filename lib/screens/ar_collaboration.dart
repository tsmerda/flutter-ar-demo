...
import 'package:brick/screens/ar_gestures.dart';

import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

class ArCollaboration extends StatefulWidget {
  const ArCollaboration({super.key});

  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<ArCollaboration> {
